...
export default function CareerCard({ career, selected, onClick}) {
 ...
 : 'border-gray-200 bg-white hover:border-primary-300 hover:shadow-card-hover hover:-translate-y-1'
 )}
 >
 ...
 <span className={clsx('text-xs font-medium', selected ? 'text-white/80' : 'text-text-secondary ')}>
