...
const difficultyColor = {
    ...
    Advanced: 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400 badge',
};
            ...
            <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h3 className="font-semibold text-sm text-text-primary dark:text-gray-100 font-poppins truncate">
                            {skill.name}
                        </h3>
                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                            <span className="text-xs text-text-secondary dark:text-gray-400">{skill.category}</span>
                            {skill.difficulty && (
                        ...
                        {Object.entries(statusConfig).map(([key, val]) => (
                            <button
                                ...
                                className={clsx(
                                    ...
                                    status === key
                                        ? key === 'completed' ? 'bg-success text-white' : key === 'in-progress' ? 'bg-amber-400 text-white' : 'bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-100'
