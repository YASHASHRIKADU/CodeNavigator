...
export default function LogoutConfirmModal({ isOpen, onClose}) {
 ...
 <button
 onClick={onClose}
 className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 :text-gray-200 transition-colors"
 aria-label="Close"
 >
 <X className="w-5 h-5"/>
 </button>
 ...
 className="text-lg font-bold font-poppins text-center text-text-primary mb-2"
 >
 Logout?
 </h3>
 ...
 <button
 onClick={onClose}
 className="flex-1 py-2.5 rounded-xl border border-gray-200 text-sm font-semibold text-text-primary hover:bg-gray-50 :bg-gray-800 transition-colors"
 >
 Cancel
 </button>
 <button
