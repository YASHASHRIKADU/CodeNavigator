        ...
        return (
            <DashboardLayout>
                <div className="text-center py-20">
                    ...
                    <p className="text-text-secondary dark:text-gray-400">No roadmap found. Please select a career path first.</p>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold font-poppins text-text-primary dark:text-gray-100">{roadmap.title}</h1>
                    </div>
                ...
                {stats.percentage === 100 && (
                    <div className="card text-center py-8 bg-gradient-to-br from-success/10 to-primary-500/10 border-2 border-success/30">
                        ...
                        <h2 className="text-xl font-bold font-poppins text-text-primary dark:text-gray-100 mb-2">Roadmap Completed!</h2>
                        <p className="text-text-secondary dark:text-gray-400">Congratulations! You've completed all skills in this roadmap.</p>
                    </div>
                )}
            </div>
        </DashboardLayout>
