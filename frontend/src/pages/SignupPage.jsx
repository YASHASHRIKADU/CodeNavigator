...
export default function SignupPage() {
 ...
 <AuthLayout>
 <div className="p-2">
 <h2 className="text-2xl font-bold font-poppins text-text-primary mb-1">Create your account</h2>
 <p className="text-text-secondary text-sm mb-6">Start your tech career journey today. It's free.</p>
