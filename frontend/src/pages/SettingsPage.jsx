...
function SettingsSection({ icon: Icon, title, children, danger = false}) {
 return (
 <div className={`card ${danger ? 'border border-red-200 ' : ''}`}>
 <div className="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
 <div className={`p-2 rounded-xl ${danger ? 'bg-red-50 ' : 'bg-primary-50 '}`}>
 <Icon className={`w-4 h-4 ${danger ? 'text-red-500' : 'text-primary-500'}`} />
 </div>
 <h2 className={`font-bold font-poppins ${danger ? 'text-red-600 ' : 'text-text-primary '}`}>
 {title}
 </h2>
 </div>
 {children}
...
export default function SettingsPage() {
 ...
 {/* Page header */}
 <div>
 <h1 className="text-2xl font-bold font-poppins text-text-primary flex items-center gap-2">
 ...
 <p className="text-xs text-text-secondary">Current Career Path</p>
 ...
 className="mt-3 flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold text-red-500 border-2 border-red-200 hover:bg-red-50 :bg-red-900/20 transition-all"
 >
 ...
 className="px-4 py-2 rounded-xl text-sm font-semibold text-text-secondary hover:bg-gray-100 :bg-gray-700 transition-all"
 >
 Cancel
 </button>
 </div>
 ...
 className="flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold text-red-500 border-2 border-red-200 hover:bg-red-50 :bg-red-900/20 transition-all"
 >
