    ...
    return (
        <DashboardLayout>
            <div className="max-w-3xl mx-auto py-8">
                ...
                <div className="bg-white dark:bg-card-dark rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            {domainsLoading ? (
                                <div className="flex items-center gap-2 text-text-secondary dark:text-gray-400 text-sm py-3">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-text-primary dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none appearance-none"
                                    required
                                >
                                    {domains.map(dom => (
                        ...
                        <div>
                            ...
                            {pathsLoading ? (
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-text-primary dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none appearance-none disabled:opacity-50"
                                    required
                                >
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-4">
                            <button
                                ...
                                className="px-6 py-3 font-semibold text-text-secondary dark:text-gray-400 hover:text-text-primary dark:hover:text-white transition-colors"
                            >
                                Cancel
                            </button>
                            <button
