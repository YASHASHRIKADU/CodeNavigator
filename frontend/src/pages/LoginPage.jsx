...
export default function LoginPage() {
 ...
 <AuthLayout>
 <div className="p-2">
 <h2 className="text-2xl font-bold font-poppins text-text-primary mb-1">Welcome back</h2>
 <p className="text-text-secondary text-sm mb-6">Log in to continue your learning journey.</p>
