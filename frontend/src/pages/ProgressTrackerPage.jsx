...
export default function ProgressTrackerPage() {
 ...
 {/* Header */}
 <div>
 <h1 className="text-2xl font-bold font-poppins text-text-primary">Progress Tracker</h1>
 ...
 <h3 className="font-bold text-text-primary font-poppins">Overall Completion</h3>
 ...
 <span className="text-text-secondary">{stats.completed} Completed</span>
 </div>
 <div className="flex items-center gap-2">
 <span className="w-3 h-3 rounded-full bg-amber-400"/>
 <span className="text-text-secondary">{stats.inProgress} In Progress</span>
 </div>
 <div className="flex items-center gap-2">
 <span className="w-3 h-3 rounded-full bg-gray-300"/>
 <span className="text-text-secondary">{stats.total - stats.completed - stats.inProgress} Not Started</span>
 </div>
 </div>
 </div>
