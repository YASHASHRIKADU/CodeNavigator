...
export default function ProfilePage() {
 ...
 { label: 'In Progress', value: stats.inProgress, icon: Award, color: 'text-amber-500', bg: 'bg-amber-100 '},
 { label: 'Total Skills', value: stats.total, icon: Award, color: 'text-blue-500', bg: 'bg-blue-50 '},
 { label: 'Completion', value: `${stats.percentage}%`, icon: CheckCircle2, color: 'text-primary-500', bg: 'bg-primary-50 '},
 ];
 ...
 <div className="w-20 h-20 rounded-2xl bg-accent border-4 border-white flex items-center justify-center shadow-card">
 ...
 <div className="mt-3">
 <h1 className="text-2xl font-bold font-poppins text-text-primary">{user?.name}</h1>
 {career && (
 ...
 <h3 className="font-bold text-text-primary font-poppins">Account Information</h3>
 ...
 <h3 className="font-bold text-text-primary font-poppins">Learning Progress</h3>
 ...
 <div>
 <p className="text-lg font-black text-text-primary font-poppins">{s.value}</p>
 ...
 <h3 className="font-bold text-text-primary font-poppins mb-2">Career Path</h3>
 <p className="text-text-secondary text-sm mb-4">
 Want to switch your career path? This will reset your progress tracking.
 </p>
 <Link to="/career"className="btn-secondary text-sm py-2 px-4 inline-flex border-gray-300 text-gray-600 hover:border-primary-400 hover:text-primary-500">
 Change Career Path
 </Link>
 </div>
 </div>
