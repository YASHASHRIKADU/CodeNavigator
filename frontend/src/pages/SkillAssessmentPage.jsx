                            ...
                            <div key={category} className="card">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        <h3 className="font-bold text-text-primary dark:text-gray-100 font-poppins">{category}</h3>
                                            ...
                                            <button
                                                ...
                                                className={clsx(
                                                    ...
                                                    checked
                                                        ...
                                                        : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-card-dark hover:border-primary-300'
                                                )}
                                            >
                                                {checked
                                                ...
                                                <span className={clsx('text-sm font-medium', checked ? 'text-primary-600 dark:text-primary-300' : 'text-text-primary dark:text-gray-100')}>
                                                    {skill.name}
                                                </span>
                                            </button>
                                        );
