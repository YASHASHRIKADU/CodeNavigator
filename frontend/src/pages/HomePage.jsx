...
export default function HomePage() {
 ...
 <div className="inline-flex items-center gap-2 bg-primary-50 text-primary-500 px-4 py-1.5 rounded-full text-sm font-semibold mb-6 border border-primary-200">
 <Star className="w-3.5 h-3.5 fill-current"/>
 Smart Learning for Tech Careers
 </div>
 <h1 className="font-poppins text-5xl lg:text-6xl font-black text-text-primary leading-tight mb-6">
 ...
 {['A', 'B', 'C', 'D'].map((l, i) => (
 <div key={i} className="w-8 h-8 rounded-full bg-primary-500 border-2 border-white flex items-center justify-center text-xs text-white font-bold">
 {l}
 </div>
 ))}
 </div>
 ...
 <p className="text-xs text-text-secondary">Loved by 2,000+ learners</p>
 </div>
 </div>
 </div>
 ...
 <div className="relative bg-white rounded-3xl shadow-card-hover p-6 border border-gray-100">
 ...
 <p className="text-xs font-semibold text-text-secondary mb-2">Frontend Roadmap Progress</p>
 ...
 <span className="text-xs w-28 truncate text-text-secondary">{r.s}</span>
 ...
 {/* Floating badges */}
 <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-card p-3 border border-gray-100 flex items-center gap-2 animate-pulse-slow">
 <CheckCircle2 className="w-5 h-5 text-success"/>
 <span className="text-xs font-semibold text-text-primary">Skill Completed!</span>
 </div>
 <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-card p-3 border border-gray-100">
 <p className="text-xs text-text-secondary">Daily Streak 🔥</p>
 ...
 <h3 className="font-bold text-lg font-poppins text-text-primary mb-2">{f.title}</h3>
 ...
 <p className="text-text-secondary max-w-xl mx-auto">Three simple steps to get your personalized tech career roadmap.</p>
 </div>
 ...
 <div className="w-24 h-24 rounded-3xl bg-white border-2 border-primary-200 flex items-center justify-center text-4xl shadow-card group-hover:shadow-card-hover group-hover:border-primary-400 transition-all duration-300 group-hover:-translate-y-1">
 {step.icon}
 </div>
 ...
 <h3 className="font-bold text-lg font-poppins text-text-primary mb-2">{step.title}</h3>
 ...
 <span className="font-bold text-sm text-text-primary font-poppins">CodeNavigator</span>
 </div>
 <p className="text-xs text-text-secondary">© 2024 CodeNavigator. Made with ❤️ for learners.</p>
 </div>
 </footer>
 </div>
 );
