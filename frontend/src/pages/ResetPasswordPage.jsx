...
export default function ResetPasswordPage() {
 ...
 Choose a new password for <strong className="text-text-primary">{email || 'your account'}</strong>.
 </p>
 ...
 {success ? (
 <div className="p-4 rounded-xl bg-green-50 border border-green-200 text-green-700 text-sm space-y-2">
